<template>
  <section
    class="flex justify-center items-center bg-[url('/img/banner-1.png')] bg-blend-multiply bg-dark-2 bg-no-repeat bg-cover w-full h-screen custom-class-nav-scroll"
    id="home"
  >
    ...
    <a href="#whatcando" class="absolute bottom-10 animate-bounce md:block hidden">
