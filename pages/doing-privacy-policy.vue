<template>
  <container class="flex flex-col gap-8 text-dark-4 p-8 text-2xl mt-28">
    <h1>Privacy Policy for CASETRUE</h1>
    <p>
      Doing does not knowingly collect any Personal Identifiable Information from children
      under the age of 13. If you think that your child provided this kind of information
      on our website, we strongly encourage you to contact us immediately and we will do
      our best efforts to promptly remove such information from our records.
    </p>
    <h1>Privacy Policy for Doing</h1>

    <p>
      At elyonousi, accessible from https://elyonousi.vercel.app, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document contains
      types of information that is collected and recorded by elyonousi and how we use it.
    </p>
    ...
    <p>
      elyonousi follows a standard procedure of using log files. These files log visitors
    ...
    <p>
      ...
      on elyonousi, which are sent directly to users' browser. They automatically receive
    ...
    <p>
      Note that elyonousi has no access to or control over these cookies that are used by
    ...
    <p>
      elyonousi's Privacy Policy does not apply to other advertisers or websites. Thus, we
      are advising you to consult the respective Privacy Policies of these third-party ad
      servers for more detailed information. It may include their practices and
    ...
    <p>
      elyonousi does not knowingly collect any Personal Identifiable Information from
