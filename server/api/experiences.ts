...
export default defineEventHandler(async (event) => {
	...
	const { data } = await client.from("experiences").select("title, employment_type, company_name, date_start, date_end, description, profile").order('created_at', { ascending: false })
